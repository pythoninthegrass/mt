...
2. **Navigate to affected pages** - Use `screencap` MCP to visit each changed view
4. **Validate feature implementation** - Ensure the change fulfills the user's specific request
5. **Check acceptance criteria** - Review any provided context files or requirements
6. **Capture evidence** - Take full page screenshot at desktop viewport (1080p) of each changed view
7. **Check for errors** - Look for any errors in stdout or Eliot logging
