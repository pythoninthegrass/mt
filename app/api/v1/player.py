...
async def next_track(
    ...
    return {"message": "Skipped to next track", "track": next_track.to_dict() if next_track else None}
...
async def previous_track(
    ...
    return {"message": "Went to previous track", "track": prev_track.to_dict() if prev_track else None}
...
async def stream_audio(
    ...
    return streaming_service.create_streaming_response(track.file_path, range_header)
